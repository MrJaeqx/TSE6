...
void pytharos_fractal(float topLeftx, float topLefty, float topRightx, float topRighty, float n, int iterations)
{
	...
	if (iterations < MAXITERATIONS) {
		pytharos_fractal(Q4x, Q4y, newx, newy, n + 0.03, iterations + 1); //left recursion
		pytharos_fractal(newx, newy, Q3x, Q3y, n + 0.08, iterations + 1); //right recursion
	}
}